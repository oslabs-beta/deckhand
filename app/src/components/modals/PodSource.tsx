...
export default function () {
  ...
  const [dockerHubImages, setDockerHubImages] = useState<ReactElement[]>([]);
  const [userRepos, setUserRepos] = useState<ReactElement[]>([]);
  const [publicRepos, setPublicRepos] = useState<ReactElement[]>([]);
