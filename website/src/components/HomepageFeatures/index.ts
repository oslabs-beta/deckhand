...
const FeatureList = [
  {
    ...
    description: (
      <>
        // @ts-expect-error TS(2304): Cannot find name 'Visual'.
  ...
  },
  {
    ...
    description: (
      <>
        // @ts-expect-error TS(2304): Cannot find name 'Instantly'.
  ...
  return (
    ...
    <div className={clsx('col col--4')}>
      ...
      <div className="text--center">
        // @ts-expect-error TS(2749): 'Svg' refers to a value, but is being used as a ty... Remove this comment to see the full error message
      ...
      <div className="container">
        ...
        <div className="row">
          {FeatureList.map((props: any, idx: any) => (
            // @ts-expect-error TS(2749): 'Feature' refers to a value, but is being used as ... Remove this comment to see the full error message
